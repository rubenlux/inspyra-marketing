...
async function main() {
  ...
  const intelRules = [
    ...
    {
      id: 'intel-sin-gbp',
      problemPattern: 'sin google business profile,sin google business,sin ficha google,google business inexistente,sin ficha gmb',
    ...
    {
      id: 'intel-gbp-sin-reclamar',
      problemPattern: 'perfil gbp sin reclamar,gbp sin reclamar,ficha sin reclamar,gbp no reclamado',
      impactoDescripcion: 'Perfil en Google Maps existe pero no está siendo gestionado — la competencia con perfiles optimizados aparece primero en las búsquedas locales',
      serviciosRecomendados: ['Gestión de Google Business Profile'],
      prioridad: 'ALTA',
      ticketEstimadoUsd: 600,
      bundleSugerido: null,
