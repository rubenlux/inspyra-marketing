...
export const CASA_VIGIL: ProspectInput = {
  id: "casa-vigil-001",
...
export const PULENTA_ESTATE: ProspectInput = {
...
export const BODEGAS_LOPEZ: ProspectInput = {
...
export const NORTON: ProspectInput = {
  id: "norton-001",
